import svgPaths from "./svg-e1u4yqsnoc";
import { imgLogoMain, imgGroup, imgGroup1, imgVector, imgVector1, imgVector2, imgVector3, imgMainLogo, imgLogoMain1, imgLogo, imgGroup2, imgGroup3, imgVector4, imgVector5, imgVector6, imgVector7, imgLogo1, imgLogo2, imgGroup4, imgGroup5 } from "./svg-sptag";
type LogoProps = {
  className?: string;
