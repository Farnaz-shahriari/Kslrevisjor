import svgPaths from "./svg-mlpj758gaj";
...
function TrailingElements() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0" data-name="Trailing-Elements">
      <div className="content-stretch cursor-pointer flex flex-col gap-[10px] items-center justify-center relative shrink-0 size-[48px]" data-name="1st trailing-icon">
        <Container1 />
      </div>
    </div>
  );
...
function QuestionListHeading() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Question list heading">
      <div className="bg-[#e9e9df] content-stretch flex gap-[4px] items-center max-w-[720px] min-w-[360px] overflow-clip relative rounded-[28px] self-stretch shrink-0 w-[360px]" data-name="Search Button">
        <StateLayer2 />
      </div>
    </div>
  );
...
export default function QuestionNavigationAfterClickingOnSokISjekklistesporsmal() {
  return (
    <div className="relative size-full" data-name="Question Navigation- after clicking on Søk i sjekklistespørsmål">
