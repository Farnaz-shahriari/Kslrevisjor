import svgPaths from "./svg-ge4d1uyk8s";
...
function TopInfo() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start py-[8px] relative shrink-0" data-name="top info">
      <InfoChips />
...
function RevisjonInfo() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[348px] items-start min-h-px min-w-px relative" data-name="Revisjon info">
      <TopInfo />
  ...
  return (
    <div className="content-stretch flex h-[32px] items-center justify-center px-[16px] py-[6px] relative shrink-0" data-name="state-layer">
      <div className="css-g0mm18 flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#44483b] text-[14px] text-center tracking-[0.1px]">
        <p className="css-ew64yg leading-[20px]">Bjørkli Økologiske</p>
      </div>
    </div>
  );
}
...
function TopInfo1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start py-[8px] relative shrink-0 w-full" data-name="Top info">
      <InfoChips1 />
...
function ForetakInfo() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[304px] items-start min-h-px min-w-px relative" data-name="Foretak info">
      <TopInfo1 />
...
function StateLayer7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center px-[24px] py-[16px] relative shrink-0" data-name="State-layer">
      <div className="css-g0mm18 flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[16px] text-white tracking-[0.15px]">
...
function Actions() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-end min-h-px min-w-px relative" data-name="Actions">
      <Button />
      <Button1 />
    </div>
  );
...
function AuditInformation() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="audit information">
      <RevisjonInfo />
      <ForetakInfo />
      <Actions />
    </div>
