import svgPaths from "./svg-j2n43pe105";
...
function RevisjonCard() {
  return (
    <div className="bg-[#fafaf0] content-stretch flex flex-col gap-[16px] items-start pb-0 pt-[8px] px-[24px] relative rounded-[12px] shrink-0 w-[888px]" data-name="Revisjon Card">
...
export default function NavigationKsl() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start px-[24px] py-[8px] relative rounded-[12px] size-full" data-name="Navigation KSL">
