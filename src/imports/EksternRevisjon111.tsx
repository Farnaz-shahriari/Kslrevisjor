import svgPaths from "./svg-jrwl7rxl2e";
...
function Frame12() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.15px] w-[263.195px]">
        <ol className="list-decimal" start="1">
          <li className="ms-[24px]">
            <span className="leading-[24px]">Helse, miljø og sikkerhet</span>
          </li>
        </ol>
      </div>
      <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[23.467px]" data-name="Expand Q">
        <div className="relative shrink-0 size-[24px]" data-name="arrow_drop_down">
          <div className="absolute inset-[41.67%_29.17%_37.5%_29.17%]" data-name="icon">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 5">
              <path d="M5 5L0 0H10L5 5Z" fill="var(--fill-0, #44483B)" id="icon" />
...
function TrackAndStop1() {
  return (
    <div className="absolute box-border content-stretch flex items-center left-0 pl-[2px] pr-0 py-0 right-0 top-1/2 translate-y-[-50%]" data-name="track-and-stop">
      <Track1 />
      <Stop1 />
    </div>
  );
...
function Frame13() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow h-[64px] items-start justify-center min-h-px min-w-px relative shrink-0">
      <Frame12 />
      <div className="h-[12px] relative shrink-0 w-full" data-name="linear-determinate">
        <TrackAndStop1 />
      </div>
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.15px] w-[263.195px]">
        <ol className="list-decimal" start="1">
          <li className="ms-[24px]">
            <span className="leading-[24px]">Drøvtyggere - generell</span>
          </li>
        </ol>
      </div>
      <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[23.467px]" data-name="Expand Q">
  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.15px] w-[263.195px]">
        <ol className="list-decimal" start="1">
          <li className="ms-[24px]">
            <span className="leading-[24px]">Småfe</span>
          </li>
        </ol>
      </div>
      <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[23.467px]" data-name="Expand Q">
...
function Frame19() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow isolate items-start min-h-px min-w-px overflow-x-clip overflow-y-auto relative shrink-0 w-full">
      <ChecklistQuestions />
      <div className="bg-white h-[64px] min-h-[64px] relative rounded-[12px] shrink-0 w-full z-[6]" data-name="checklist Question">
        <div className="flex flex-row items-center min-h-inherit size-full">
          <div className="box-border content-stretch flex gap-[16px] h-[64px] items-center min-h-inherit p-[8px] relative w-full">
            <Frame13 />
          </div>
        </div>
      </div>
      <div className="bg-white h-[64px] min-h-[64px] relative rounded-[12px] shrink-0 w-full z-[5]" data-name="checklist Question">
        <div className="flex flex-row items-center min-h-inherit size-full">
          <div className="box-border content-stretch flex gap-[16px] h-[64px] items-center min-h-inherit p-[8px] relative w-full">
            <Frame16 />
          </div>
      ...
      <div className="bg-white h-[64px] min-h-[64px] relative rounded-[12px] shrink-0 w-full z-[3]" data-name="checklist Question">
        <div className="flex flex-row items-center min-h-inherit size-full">
          <div className="box-border content-stretch flex gap-[16px] h-[64px] items-center min-h-inherit p-[8px] relative w-full">
            <Frame18 />
          </div>
...
function Content24() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-clip relative shrink-0" data-name="Content">
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.5px] w-full">
        <p className="leading-[24px]">Matlovsforskriften</p>
      </div>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#44483b] text-[14px] tracking-[0.25px] w-full">{`Artikkel 18 Sporbarhet	`}</p>
    </div>
  );
}
...
function Content25() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-clip relative shrink-0" data-name="Content">
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.5px] w-full">
        <p className="leading-[24px]">Bokføringsloven</p>
      </div>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#44483b] text-[14px] tracking-[0.25px] w-full">Bokføringsloven</p>
    </div>
  );
}
...
function Content26() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-clip relative shrink-0" data-name="Content">
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1a1c16] text-[16px] tracking-[0.5px] w-full">
        <p className="leading-[24px]">Straffeloven</p>
      </div>
      <p className="font-['Manrope:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#44483b] text-[14px] tracking-[0.25px] w-full">{`Se kap 30.	`}</p>
    </div>
  );
}
...
function Content27() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow h-full items-start justify-center leading-[0] min-h-px min-w-px overflow-clip relative shrink-0 tracking-[0.5px]" data-name="Content">
      ...
      <div className="flex flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#1a1c16] text-[16px] w-full">
        <p className="leading-[24px]">{`Åpenhetsloven	`}</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start px-[24px] py-[8px] relative w-full">
          <div className="-webkit-box flex-col font-['Manrope:Regular',sans-serif] font-normal justify-center leading-[0] overflow-ellipsis overflow-hidden relative shrink-0 text-[#1a1c16] text-[0px] tracking-[0.5px] w-full">
            <p className="leading-[24px] mb-0 text-[16px]">Dette bør du spørre om på dokumentgjennomgang:</p>
            <p className="leading-[24px] mb-0 text-[16px]">&nbsp;</p>
            <ul className="list-disc mb-0">
              <li className="mb-0 ms-[calc(1.5*1*var(--list-marker-font-size,0))]">
                <span className="font-['Manrope:Regular',sans-serif] font-normal leading-[24px] text-[16px] tracking-[0.5px]">Be om dokumentasjon på kjøp av eks for, gjødsel eller drivstoff. Følg opp med spørsmål om hvor på gården det brukt/hvilke dyr som har fått hvilket for (intern sporing).</span>
              </li>
              <li className="ms-[calc(1.5*1*var(--list-marker-font-size,0))]">
                <span className="font-['Manrope:Regular',sans-serif] font-normal leading-[24px] text-[16px] tracking-[0.5px]">Be om dokumentasjon på salg av melk, slakt, grovfor etc.</span>
              </li>
            </ul>
            <p className="leading-[24px] mb-0 text-[16px]">&nbsp;</p>
            <p className="leading-[24px] mb-0 text-[16px]">&nbsp;</p>
            <p className="leading-[24px] text-[16px]">
              <span className="font-['Manrope:Regular',sans-serif] font-normal">{`Har bonden oversikt og god kontroll på `}</span>
              <span className="font-['Manrope:Bold',sans-serif] font-bold">sporing?</span>
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex-none h-full rotate-[90deg]">
            <div className="h-full relative w-[120px]" data-name="Divider">
              <div className="absolute bottom-0 left-0 right-0 top-[-1px]" style={{ "--stroke-0": "rgba(196, 200, 183, 1)" } as React.CSSProperties}>
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1803 1">
                  <line id="Divider" stroke="var(--stroke-0, #C4C8B7)" x2="1802.32" y1="0.5" y2="0.5" />
                </svg>
              </div>
            </div>
          </div>
...
export default function EksternRevisjon111() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-[16px] shadow-[0px_8px_12px_6px_rgba(0,0,0,0.15),0px_4px_4px_0px_rgba(0,0,0,0.3)] size-full" data-name="ekstern revisjon- 1.1.1">
      <Frame6 />
    </div>
  );
}