import svgPaths from "./svg-nh1bgog2fz";
...
export default function NeedsActionAuditsNavigation() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative size-full" data-name="needs action audits navigation">
      <RevisorCard />
      <RevisorCard1 />
    </div>
  );
