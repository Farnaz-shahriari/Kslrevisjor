import svgPaths from "./svg-4sinif3nyt";
...
function RequirementSection1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Requirement section">
      <RequirementSection />
      <ScrollableContainer />
    </div>
  );
...
export default function KravOgVeileder() {
  return (
    <div className="bg-[#fafaf0] box-border content-stretch flex flex-col gap-[8px] items-center px-0 py-[8px] relative rounded-[12px] size-full" data-name="krav og veileder">
